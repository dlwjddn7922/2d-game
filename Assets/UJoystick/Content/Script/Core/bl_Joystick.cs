...
public class bl_Joystick : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IDragHandler
{
    ...
    [SerializeField] private GameObject sitck;
    [SerializeField] private GameObject joy;
    [SerializeField] private GameObject cen;
    ...
    {
        isPointDown = true;
        //sitck.transform.position = Input.mousePosition;
        //CenterReference.transform.position = Input.mousePosition;
        //DeathArea = Input.mousePosition;
